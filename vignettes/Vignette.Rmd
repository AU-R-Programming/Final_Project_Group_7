...
The `train_test_sampling` function helps you split your data into training and test sets. Here, we use an 80-20 split.
...
- **Diagnostic Odds Ratio**: The ratio of the odds of a positive test result in a diseased individual to the odds of a positive test result in a non-diseased individual.
...
Try using the `TrainPredict` package with your own dataset to explore its functionalities further.
